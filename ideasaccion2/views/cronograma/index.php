...
<script nonce="<?= getnonceideas() ?>"  src="<?= \Yii::$app->request->BaseUrl ?>/js/libs/2.1.0/jquery-2.1.0.js"></script>

<link rel="stylesheet" type="text/css" href="<?= \Yii::$app->request->BaseUrl ?>/css/jqueryui/jquery-ui.css">
<script nonce="<?= getnonceideas() ?>"  src="<?= \Yii::$app->request->BaseUrl ?>/js/libs/1.11.4/jquery-ui.js"></script>
