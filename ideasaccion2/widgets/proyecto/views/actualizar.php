...
$acti3 = 0;
?>
<script nonce="<?= getnonceideas() ?>" type="text/javascript" src="<?= \Yii::$app->request->BaseUrl ?>/js/libs/3.3.2/bootstrap.min.js"></script>

<script nonce="<?= getnonceideas() ?>" type="text/javascript" src="<?= \Yii::$app->request->BaseUrl ?>/js/libs/master/material.min.js"></script>
<script nonce="<?= getnonceideas() ?>" type="text/javascript" src="<?= \Yii::$app->request->BaseUrl ?>/js/libs/moments/moment-with-locales.min.js"></script>
<script nonce="<?= getnonceideas() ?>" type="text/javascript" src="<?= \Yii::$app->request->BaseUrl ?>/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js"></script>
...
<script nonce="<?= getnonceideas() ?>" src="<?= \Yii::$app->request->BaseUrl ?>/kartik-v-bootstrap-fileinput/js/plugins/canvas-to-blob.min.js" type="text/javascript"></script>
<!-- sortable.min.js is only needed if you wish to sort / rearrange files in initial preview.
     This must be loaded before fileinput.min.js -->
<script nonce="<?= getnonceideas() ?>" src="<?= \Yii::$app->request->BaseUrl ?>/kartik-v-bootstrap-fileinput/js/plugins/sortable.min.js" type="text/javascript"></script>
<!-- purify.min.js is only needed if you wish to purify HTML content in your preview for HTML files.
     This must be loaded before fileinput.min.js -->
<script nonce="<?= getnonceideas() ?>" src="<?= \Yii::$app->request->BaseUrl ?>/kartik-v-bootstrap-fileinput/js/plugins/purify.min.js" type="text/javascript"></script>
<!-- the main fileinput plugin file -->
<script nonce="<?= getnonceideas() ?>" src="<?= \Yii::$app->request->BaseUrl ?>/kartik-v-bootstrap-fileinput/js/fileinput.min.js"></script>
<!-- bootstrap.js below is needed if you wish to zoom and view file content 
     in a larger detailed modal dialog -->
<script nonce="<?= getnonceideas() ?>" src="<?= \Yii::$app->request->BaseUrl ?>/js/libs/3.3.6/bootstrap.min.js" type="text/javascript"></script>
<!-- optionally if you need a theme like font awesome theme you can include 
    it as mentioned below -->
<!-- optionally if you need translation for your language then include 
    locale file as mentioned below -->
<script nonce="<?= getnonceideas() ?>" src="<?= \Yii::$app->request->BaseUrl ?>/kartik-v-bootstrap-fileinput/js/locales/es.js"></script>
