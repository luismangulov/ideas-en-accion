...
//$invitacion=Invitacion::find()->where('equipo_id=:equipo_id and estado=1',[':equipo_id'=>$equipo->id])->one();
    ...
    <html lang="<?= Yii::$app->language ?>">
        <head>
            ...
            <link rel="stylesheet" href="<?= \Yii::$app->request->BaseUrl ?>/css/bootstrap/font-awesome.min.css">
            ...
            <script nonce="<?= getnonceideas() ?>"  src="<?= \Yii::$app->request->BaseUrl ?>/js/bootbox.min.js"></script>
                                    ...
                                    <div class="grid_box_line_blue">
                                        <ul class="menu_lateral">
                                            ...
                                            <?php if ($integrante && $equipo && $estudiante->grado != 6) { ?>
                                                <li>
                                                    <a href="#" class="sub_menu" id="lnkForos">
                                                        <div class="table_div">
                                                            <div class="row_div">
                                                                <div class="cell_div div_ia_icon">
                                                    ...
                                                    <ul>
                                                        <?php foreach ($foros as $foro): ?>
                                                            <?php if ($foro->id == 2 || ($integrante && $foro->asunto_id == $equipo->asunto_id)) { ?>
                                                                <?php if ($foro->id == 2) { ?>
                                                                    <li><?= Html::a("Foro de participación estudiantil", ['foro/view', 'id' => $foro->id], ['id' => 'lnk_foropestudiantil']); ?></li>
                                                                <?php } elseif ($foro->asunto_id) { ?>
                                                                    <li><?= Html::a("Foro de asunto público", ['foro/view', 'id' => $foro->id], ['id' => 'lnk_foroasunto']); ?></li>
                                                                <?php } ?>
                                                            <?php } ?>
                                                        <?php endforeach; ?>
                                                    </ul>
