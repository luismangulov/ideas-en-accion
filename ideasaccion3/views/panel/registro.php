...
.img-responsive {
  ...
  <script nonce="<?= getnonceideas() ?>"  src="<?= \Yii::$app->request->BaseUrl ?>/js/libs/1.8.2/jquery-1.8.2.js"></script>
  
  <script nonce="<?= getnonceideas() ?>"  src="<?= \Yii::$app->request->BaseUrl ?>/js/libs/1.8.24/jquery-ui.js"></script>
...
<div class="box_head title_content_box">
    <img src="<?= \Yii::$app->request->BaseUrl ?>/img/icon_ideas_big.png" alt=""> Registro
</div>
            ...
            <div class="right_photo">
                <div class="txt_upload" style="bottom: 0px;">
                    <div class=" form-group " style="padding-bottom: 0px;">
                         ...
                         <?= Html::img('../foto_personal/no_disponible.jpg',['id'=>'img_destino','class'=>'text-center','style'=>"height: 150px;width: 120px;align:center;cursor: pointer"]) ?>
                    </div>
                </div>
            </div>
