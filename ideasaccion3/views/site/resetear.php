...
?>
<script nonce="<?= getnonceideas() ?>"  src="//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
<script nonce="<?= getnonceideas() ?>"  src="../bootstrap-strength-meter-master/docs/js/jquery-2.1.1.min.js"></script>
<script nonce="<?= getnonceideas() ?>"  src="../bootstrap-strength-meter-master/docs/js/bootstrap-3.2.0.min.js"></script>
<script nonce="<?= getnonceideas() ?>"  src="../bootstrap-strength-meter-master/docs/js/prettify.js"></script>
<script nonce="<?= getnonceideas() ?>"  src="../bootstrap-strength-meter-master/dist/js/bootstrap-strength-meter.js"></script>

<script nonce="<?= getnonceideas() ?>"  src="../bootstrap-strength-meter-master/password-score/password-score.js"></script>
<script nonce="<?= getnonceideas() ?>"  src="../bootstrap-strength-meter-master/password-score/password-score-options.js"></script>
<br>
