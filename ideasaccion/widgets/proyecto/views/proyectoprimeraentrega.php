...
<div class="box_content contenido_seccion_crear_equipo">
    <div class="row" >
        <div style="border: 2px solid #1f2a69;padding: 10px" class="text-justify">
            ...
            <b>Institución educativa:</b> <?= htmlentities($institucion->denominacion, ENT_QUOTES) ?><br>
                        ...
                        <div class="col-md-12" style="height: 660px; ">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group label-floating field-proyecto-resumen required">
                                    <label class="control-label" for="proyecto-resumen" >Resumen del proyecto</label>
                ...
                <div class="tab-pane" id="tab_2">
                    ...
                    <?php if ($videoprimera) {
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                            <?php
                            if ($videoprimera->ruta && $videoprimera->tipo == 1) {
                                $url = $videoprimera->ruta;
